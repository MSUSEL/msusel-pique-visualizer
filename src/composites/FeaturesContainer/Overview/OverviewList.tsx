        ...
        {overviewData.qualityAspectsCount[0] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-1">
            <AccordionTrigger className="SevereTitleCard">
              <CrossCircledIcon />
              Severe: {overviewData.qualityAspectsCount[0]}
            </AccordionTrigger>
            <AccordionContent className="SevereBackground">
              <OverviewDropList
                riskLvl="severe"
                section="quality_aspects"
                ovData={overviewData}
              />
            </AccordionContent>
          </Accordion.Item>
        ...
        {overviewData.qualityAspectsCount[1] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-2">
            <AccordionTrigger className="HighTitleCard">
              <ExclamationTriangleIcon />
              High: {overviewData.qualityAspectsCount[1]}
            </AccordionTrigger>
        ...
        {overviewData.qualityAspectsCount[2] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-3">
            <AccordionTrigger className="ModerateTitleCard">
              <QuestionMarkCircledIcon />
              Moderate: {overviewData.qualityAspectsCount[2]}
            </AccordionTrigger>
        ...
        {overviewData.qualityAspectsCount[3] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-4">
            <AccordionTrigger className="MinorTitleCard">
              <InfoCircledIcon />
              Minor: {overviewData.qualityAspectsCount[3]}
            </AccordionTrigger>
        ...
        {overviewData.qualityAspectsCount[4] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-5">
            <AccordionTrigger className="InsignificantTitleCard">
              <CheckCircledIcon />
              Insignificant: {overviewData.qualityAspectsCount[4]}
            </AccordionTrigger>
      ...
      >
        {overviewData.qualityFactorsCount[0] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-1" color="red">
            <AccordionTrigger className="SevereTitleCard">
              <CrossCircledIcon />
              Severe: {overviewData.qualityFactorsCount[0]}
            </AccordionTrigger>
            <AccordionContent className="SevereBackground">
              <OverviewDropList
                riskLvl="severe"
        ...
        {overviewData.qualityFactorsCount[1] != 0 && (
          ...
          >
            <AccordionTrigger className="HighTitleCard">
              <ExclamationTriangleIcon />
              High: {overviewData.qualityFactorsCount[1]}
            </AccordionTrigger>
            <AccordionContent className="HighBackground">
              <OverviewDropList
                riskLvl="high"
        ...
        {overviewData.qualityFactorsCount[2] != 0 && (
          ...
          >
            <AccordionTrigger className="ModerateTitleCard">
              <QuestionMarkCircledIcon />
              Moderate: {overviewData.qualityFactorsCount[2]}
            </AccordionTrigger>
            <AccordionContent className="ModerateBackground">
              <OverviewDropList
                riskLvl="moderate"
        ...
        {overviewData.qualityFactorsCount[3] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-4" color="blue">
            <AccordionTrigger className="MinorTitleCard">
              <InfoCircledIcon />
              Minor: {overviewData.qualityFactorsCount[3]}
            </AccordionTrigger>
            <AccordionContent className="MinorBackground">
              <OverviewDropList
                riskLvl="minor"
        ...
        {overviewData.qualityFactorsCount[4] != 0 && (
          ...
          >
            <AccordionTrigger className="InsignificantTitleCard">
              <CheckCircledIcon />
              Insignificant: {overviewData.qualityFactorsCount[4]}
            </AccordionTrigger>
            <AccordionContent className="InsignificantBackground">
              <OverviewDropList
                riskLvl="insignificant"
      ...
      >
        {overviewData.measuresCount[0] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-1">
            <AccordionTrigger className="SevereTitleCard">
              <CrossCircledIcon />
              Severe: {overviewData.measuresCount[0]}
            </AccordionTrigger>
            <AccordionContent className="SevereBackground">
              <OverviewDropList
                riskLvl="severe"
        ...
        {overviewData.measuresCount[1] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-2">
            <AccordionTrigger className="HighTitleCard">
              <ExclamationTriangleIcon />
              High: {overviewData.measuresCount[1]}
            </AccordionTrigger>
            <AccordionContent className="HighBackground">
              <OverviewDropList
                riskLvl="high"
        ...
        {overviewData.measuresCount[2] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-3">
            <AccordionTrigger className="ModerateTitleCard">
              <QuestionMarkCircledIcon />
              Moderate: {overviewData.measuresCount[2]}
            </AccordionTrigger>
            <AccordionContent className="ModerateBackground">
              <OverviewDropList
                riskLvl="moderate"
        ...
        {overviewData.measuresCount[3] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-4">
            <AccordionTrigger className="MinorTitleCard">
              <InfoCircledIcon />
              Minor: {overviewData.measuresCount[3]}
            </AccordionTrigger>
            <AccordionContent className="MinorBackground">
              <OverviewDropList
                riskLvl="minor"
        ...
        {overviewData.measuresCount[4] != 0 && (
          <Accordion.Item className="AccordionItem" value="item-5">
            <AccordionTrigger className="InsignificantTitleCard">
              <CheckCircledIcon />
              Insignificant: {overviewData.measuresCount[4]}
            </AccordionTrigger>
            <AccordionContent className="InsignificantBackground">
              <OverviewDropList
                riskLvl="insignificant"
